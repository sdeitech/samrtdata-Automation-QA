...
class SignUpPage(BaseHelpers):
    ...
    def enter_mail_address(self, address):
        try:
            ...
            self.mouse_click_action(SignUpPageXpath.mail_addr_list)
    ...
    def select_gender(self):
        try:
            ...
            self.mouse_click_action(SignUpPageXpath.female_btn)
        except Exception as e:
    ...
    def create_new_smartData2_account(self, email, firstname, lastname, dob, address, phone):
        self.enter_email(self.add_random_string_to_email(email))
        # self.enter_firstname(firstname)
        # self.enter_lastname(lastname)
        self.enter_dob(dob)
