...
class TestsmartData1153(BaseTest):
    ...
    @pytest.mark.smoke
    @allure.title("smartData1-153: Create a mock up of 2 different shopping options on the patient portal")
    def test_toottip(self):
        try:
            ...
            dashboard.click_shop_vaporiser_btn()
            dashboard.click_shop_accessories_btn()
        except:
            assert False
